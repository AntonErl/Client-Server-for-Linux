...
client: client.cpp
	g++ -Wall client.cpp -o client -std=c++14

server_one_thread: server_one_thread.cpp
	g++ -Wall server_one_thread.cpp -o server_one_thread -lpthread -std=c++14

server_two_thread: server_two_thread.cpp
	g++ -Wall server_two_thread.cpp -o server_two_thread -lpthread -std=c++14

server_three_thread: server_three_thread.cpp
	g++ -Wall server_three_thread.cpp -o server_three_thread -lpthread -std=c++14
